...
def main():
    ...
    parse.add_argument('--img-per-page', type=positive_type, default=20, help='specify how many image(s) in one view')
    parse.add_argument('--archive-per-page', type=positive_type, default=20, help='specify how many archive(s) in one subindex')
